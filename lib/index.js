...
var ForkTsCheckerWebpackPlugin = /** @class */ (function () {
    ...
    ForkTsCheckerWebpackPlugin.prototype.pluginStart = function () {
        var _this = this;
        this.compiler.hooks.run.tapAsync(checkerPluginName, function (_compiler, callback) {
            _this.isWatching = false;
            callback();
        });
        this.compiler.hooks.watchRun.tapAsync(checkerPluginName, function (_compiler, callback) {
    ...
    ForkTsCheckerWebpackPlugin.prototype.pluginStop = function () {
        var _this = this;
        this.compiler.hooks.watchClose.tap(checkerPluginName, function () {
            _this.killService();
        });
    ...
    ForkTsCheckerWebpackPlugin.prototype.pluginEmit = function () {
        var _this = this;
        this.compiler.hooks.emit.tapAsync(checkerPluginName, function (compilation, callback) {
